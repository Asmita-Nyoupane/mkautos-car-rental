        ...
        <section className='space-y-12 py-12'>
            ...
            <div className='flex flex-wrap gap-8 justify-center items-center'>
                {serviceData.map((service, i) => (
                    ...
                    <Card key={i} className='flex flex-col gap-4 items-center justify-center bg-gray-50 shadow-md rounded-lg  w-[250px] h-[300px] overflow-hidden transition transform hover:scale-105 hover:shadow-lg  duration-300 ease-in-out'>
